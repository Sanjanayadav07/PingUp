...
//inngest function save data into database
...
//inngest function to delete story 24 hours
...
const sendNotificationOfUnseenMessages = inngest.createFunction(
    ...
    {cron: "TZ=America/New_York 0 9 * * * "}, //everday 9am 
    async ({step}) => {
        const messages = await Messagefind({seen: false}).populate('to_user_id')
        const unseenCount = {}
        ...
        for(const userId in unseenCount) {
            ...
            const body = `
            <div style =" font-family: Arial, sans-serif; padding: 200px;">
            <h2> Hi ${user.full_name},</h2>
            <p>You hava ${unseenCount[userId]} unseen messages</p>
